...
namespace cep {
    ...
    public:
        ...
        Config(std::string filename = "./conf/config.sys", std::string delimiter = "=", std::string comment = "#");
        //    Config();
        ...
        std::string getProperty(string key, string defaultValue) {
            string value;
        ...
        unsigned int getPropertyInt(string key, string defaultValue) {
...
//            : filename(filename_) {
//                if_exit = false;
//                cout << "Can not find or no power to open the file [" << filename << "]" << endl;
//            }
//        };
